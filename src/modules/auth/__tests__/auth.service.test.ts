...
describe("AuthService", () => {
	...
	describe("validateUserByEmail", () => {
		it("should return user without password when found", async () => {
			...
			const result = await service.validateUserByEmail("test@example.com");
		...
		it("should return null when user not found", async () => {
			...
			const result = await service.validateUserByEmail("notfound@test.com");
	...
	describe("validateGoogleUser", () => {
		...
		it("should throw BadRequestException when profile has no email", async () => {
			...
			await expect(service.validateGoogleUser(profileNoEmail)).rejects.toThrow(
				BadRequestException,
			);
		});
